...
template<bool B, class T, class F> constexpr //
    auto conditional_val = &val<T>;
template<class T, class F> constexpr //
    auto conditional_val<false, T, F> = &val<F>;

template<bool B, class T, class F> //
using conditional_t = decltype(conditional_val<B, T, F>());
