...
template<size_t I, class... Ts> using TypeAt =
    decltype(typeAtImpl<I>(nullptr_to<IndexTypeCombo<std::make_index_sequence<sizeof...(Ts)>, Ts...>>));

template<size_t I, class TC> using TypeComboAt = decltype(typeAtImpl<I>(nullptr_to<TC>));
