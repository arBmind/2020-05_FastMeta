...
struct conditional<false> {
    template<class, class T> using type = T;
};

template<size_t I, class Is, class... Ts> struct TypeAtImpl;
template<size_t I, size_t... Is, class... Ts> //
struct TypeAtImpl<I, std::index_sequence<Is...>, Ts...>
    : FoldRec<typename conditional<Is == I>::template type<Ts, NoType>...> {};

template<size_t I, class... Ts> //
using TypeAt = typename TypeAtImpl<I, std::make_index_sequence<sizeof...(Ts)>, Ts...>::type;
