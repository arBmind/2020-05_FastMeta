...
template<size_t I, class... Ts, size_t... Is> auto typeAt(TypePack<Ts...>*, std::index_sequence<Is...>*) ->
    typename FoldRec<std::conditional_t<Is == I, Ts, NoType>...>::type;

template<size_t I, class... Ts> using TypeAt =
    decltype(typeAt<I>(nullptr_to<TypePack<Ts...>>, nullptr_to<std::make_index_sequence<sizeof...(Ts)>>));
