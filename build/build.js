...
},{"insert-css":17}],2:[function(require,module,exports){
  ...
  return function(deck) {
    var activeSlideIndex,
      ...
      activateBullet = function(slideIndex, bulletIndex) {
        var fire = activeSlideIndex == slideIndex && bulletIndex != activeBulletIndex;
        var oldBulletIndex = activeBulletIndex;
        ...
        if (fire) {
          deck.fire('deactivateBullet', oldBulletIndex);
          deck.fire('activateBullet', bulletIndex);
        }
      },
      bullet = function (bulletIndex) {
        if (arguments.length) {
          activateBullet(activeSlideIndex, bulletIndex);
        }
        else {
          return activeBulletIndex;
        }
      },
      slideBullets = function (slideIndex) {
        if (slideIndex === undefined) slideIndex = activeSlideIndex;
        return bullets[slideIndex]
      },
    ...
    deck.on('next', next);
    deck.on('prev', prev);
    deck.on('bullet', bullet);
    deck.bullet = bullet;
    deck.bullets = slideBullets;
...
},{"insert-css":17}],5:[function(require,module,exports){
module.exports = function() {
  return function(deck) {
...
},{"bespoke":16,"bespoke-blackout":1,"bespoke-bullets":2,"bespoke-classes":3,"bespoke-cursor":4,"bespoke-fullscreen":5,"bespoke-hash":6,"bespoke-nav":9,"bespoke-onstage":10,"bespoke-overview":11,"bespoke-progress":12,"bespoke-scale":13,"bespoke-slidenumber":14,"bespoke-title":15,"prismjs":25,"prismjs/components/prism-c":18,"prismjs/components/prism-cmake":19,"prismjs/components/prism-cpp":20,"prismjs/components/prism-qml":21,"prismjs/plugins/keep-markup/prism-keep-markup":22,"prismjs/plugins/show-language/prism-show-language":23,"prismjs/plugins/toolbar/prism-toolbar":24}]},{},[26]);
